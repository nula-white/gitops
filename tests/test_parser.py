...
from prism.parser.normalizer     import ASTNormalizer
from prism.parser.security_annotator import SecurityAnnotator
from prism.parser.parsers.fallback_parser import FallbackParser
...
class TestTreeSitterParser:
    def setup_method(self):
        from prism.parser.parsers.treesitter_parser import TreeSitterParser
